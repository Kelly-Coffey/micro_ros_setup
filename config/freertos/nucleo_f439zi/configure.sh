...
EXTENSIONS_DIR=$FW_TARGETDIR/freertos_apps/microros_nucleo_f439zi_extensions
...
if [ "$UROS_TRANSPORT" == "udp" ]; then
      ...
      cp -f $EXTENSIONS_DIR/Src/olimex_f439_serial_transport.c $FW_TARGETDIR/mcu_ws/eProsima/Micro-XRCE-DDS-Client/src/c/profile/transport/serial/serial_transport_external.c
      cp -f $EXTENSIONS_DIR/Inc/olimex_f439_serial_transport.h $FW_TARGETDIR/mcu_ws/eProsima/Micro-XRCE-DDS-Client/include/uxr/client/profile/transport/serial/serial_transport_external.h
